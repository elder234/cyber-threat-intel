...
const NAV: { to: string; label: string; glyph: JSX.Element }[] = [
  ...
  { to: '/pcaps', label: 'PCAPs', glyph: <Glyph d="M4 6h16M4 12h16M4 18h16" /> },
  { to: '/exposure', label: 'Exposure', glyph: <Glyph d="M12 3l8 4v6c0 4-3 7-8 8-5-1-8-4-8-8V7z" /> },
  { to: '/video', label: 'Video', glyph: <Glyph d="M4 5h12v14H4zM16 9l4-2v10l-4-2" /> },
